...
const MyOrders = () => {
    ...
    return (
        <>
            <Navbar />
            <div className="flex flex-col justify-between px-6 md:px-16 lg:px-32 py-6 min-h-screen max-w-[90rem] mx-auto pt-60">
                    ...
                    {loading ? <Loading /> : (<div className="max-w-5xl border-t border-gray-300 text-sm">
                        {orders.map((order, index) => (
                            <div key={index} className="flex flex-col md:flex-row gap-5 justify-between p-5 border-b border-gray-300">
                                ...
                                <p className="font-medium my-auto">{order.amount.toLocaleString('vi-VN')}</p>
                                <div>
